1、功能说明
	1、COMP5的输出刹车TIM1 TIM8的互补信号，COMP OUT变低后恢复TIM1 TIM8波形
2、使用环境
...
3、使用说明
	系统配置；
		...
		4、COMP：
		            COMP5输出触发TIM1 TIM8刹车，无输出时恢复TIM1 TIM8输出
	使用方法：
		1、编译后打开调试模式，将PE2连接到PA3，PE3连接到PB10，利用示波器或者逻辑分析仪观察TIM1 TIM8输出波形
