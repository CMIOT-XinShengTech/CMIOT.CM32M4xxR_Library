...
#define EEPROM_START_ADDRESS    (0x0807F000U)  //use flash 0x0800F000 - 0x08010000, for 64k flash mcu
#define EEPROM_END_ADDRESS      (0x0807F000U + EEPROM_PART0_SIZE + EEPROM_PART1_SIZE)
...
//#define USE_EEPROM_IN_FLASH_LOG

#ifdef USE_EEPROM_IN_FLASH_LOG
	#define LOG_Assert "[A] "
	#define LOG_Error "[E] "
	#define LOG_Warn "[W] "
	#define LOG_Info "[I] "
