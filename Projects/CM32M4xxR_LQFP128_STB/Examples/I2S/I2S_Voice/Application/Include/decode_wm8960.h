/***********************************************************************************************//**
 * \file decode_wm8960.h
 *
 * Description: This file contains the function prototypes and constants used
 * in decode_wm8960.c. This driver is intended for the WM8960 audio codec.
 *
 ***************************************************************************************************
 * \copyright
...
#ifndef __DECODE_WM8960_H__
#define __DECODE_WM8960_H__
...
#define WM8960_AUDIO_INTF0_LRP_INV          0x010u /**< Right, left and I2S modes 鈥� LRCLK polarity.
...
#define CY_HI8(value) (value >> 8)

#define CY_LO8(value) (value & 0xFF)
